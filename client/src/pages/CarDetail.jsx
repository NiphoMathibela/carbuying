  ...
  return (
    <div className="w-9/12 mx-auto mt-8 ">
      <div className=" flex flex-row justify-between mb-4">
        ...
        <p className=" text-3xl text-left text-[#3563E9] font-bold">
          R {carInfo.price}
        </p>
      </div>
      {/* IMage div */}
      ...
      <div className=" my-4 bg-white p-3">
        ...
        <div className="flex flex-row items-center justify-between bottom-6 w-3/12 mt-4">
          ...
          <p className="flex flex-row items-center text-base text-[#90A3BF]">
            <TbManualGearbox size={24} color="#90A3BF" /> {carInfo.gearType}
          </p>
          <p className="flex flex-row items-center text-base text-[#90A3BF]">
            <SlSpeedometer size={26} color="#90A3BF" /> {carInfo.mileage}
          </p>
        </div>
        ...
        <table className=" w-6/12 border-collapse border rounded-md p-2">
          ...
          <tr>
            <td className="font-semibold text-left">Previous owners</td>
            <td>1</td>
          </tr>
          <tr className="bg-[#F6F7F9]">
            <td className="font-semibold text-left">Service History</td>
            <td>Full</td>
          </tr>
          <tr>
            <td className="font-semibold text-left">Colour</td>
            <td>{carInfo.colour}</td>
          </tr>
          <tr className="bg-[#F6F7F9]">
            <td className="font-semibold text-left">Body type</td>
